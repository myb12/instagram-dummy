        ...
        <div className='post-card'>
            ...
            <div className="reaction">
                <div className='d-flex align-items-center'>
                    <div className="heart" onClick={handleHeartClick}>
                        {
                            heartClicked ? <svg className='heart-clicked' aria-label="Unlike" color="#ed4956" fill="#ed4956" height="24" role="img" viewBox="0 0 48 48" width="24">
                                ...
                                :
                                <svg aria-label="Like" className="reaction-icons" color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 24 24" width="24">
                    ...
                    <div className="comment">
                        <svg aria-label="Comment" className="reaction-icons" color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 24 24" width="24">
                    ...
                    <div className="share">
                        <svg aria-label="Share Post" className="reaction-icons" color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 24 24" width="24">
            ...
            <div className="post-card-footer">
                <div className='d-flex align-items-center'>
                    ...
                    <input className='post-card-input form-control border-0' type="text" name="" id="" placeholder='Add a comment' />
                </div>
